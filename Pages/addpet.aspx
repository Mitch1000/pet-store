<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="addpet.aspx.cs" Inherits="PetStore.Pages.addpet" %>
...
<asp:label runat="server" id="notRegisteredError" ForeColor="Red" Font-Size="Large" />  
   ...
   <custom:LeftNav ID="oLeftNav" runat="server"></custom:LeftNav>
     ...
     <div class="center_pet_pages" id="pageContent" runat="server">
                ...
                <div class="pet_regform">
                    ...
                    <table>
                       <tr ><td  class="PetregLavel">Name:</td><td> <asp:TextBox ID="txtFirstname" runat="server" CssClass="reg_input" /></td></tr>
                        ...
                        <tr><td></td><td></td></tr>
                        <tr><td></td><td>
                             <asp:button runat="server" ID="btnCancel" CssClass ="submit" Text="CANCEL" OnClick ="btnCancel_Click" />
                &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
